...
public class FileParserCSV {
    ...
    throws FileNotFoundException, IOException { 
        ...
        String line; 
        int numInputLines=0, numDataLines=0;
        ...
        reader.close();
        int numFields = headers.length;  // assumption about the file
        results = new Object[numDataLines][numFields];
        ...
        } else if (numFields != results[0].length) {
